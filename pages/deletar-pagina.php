...
?>
<div class="title_box borderradius5">Deletar Página</div><!--/title_box-->
<span class="text_del">Você realmente deseja <strong>excluir</strong> essa página?</span>
...
<form name="Form_del_user" action="" method="post">
    ...
    if (isset($_POST['sim']) && $_POST['sim'] == 'Sim') {
        ...
        $deletarPagina = delete('paginas', "id='$id'");
        if (!$deletarPagina) {
            echo '<div class="msg ok borderradius5" style="width:280px;margin:20px auto;">Página deletada. Atualizando página...</div>';
